...
type SharpnessLevels = {
  [key: string]: Readonly<InstanceType<SharpnessLevelClass>> | null;
};
 ...
 */
export interface Sharpness extends SharpnessLevels {}

export class SharpnessBuilder {
  private readonly sharpness: Sharpness = {
    red: null,
    orange: null,
    yellow: null,
    green: null,
